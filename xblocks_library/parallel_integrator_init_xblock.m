...
adder_tree_out = cell(1,n_inputs);
for i=1:n_inputs,
    adder_tree_out{i} = xSignal(['adder_tree_out',num2str(i)]);
...
convert_blks = cell(1,n_inputs);
for i =1:n_inputs
    convert_blks{i} = xBlock(struct('source', 'Convert', 'name', ['convert',num2str(i)]), ...
