...
% TODO: turn this into a function for vectors
for n=1:n_inputs
	vacc_core_config.source = str2func('vacc_core_init_xblock');
	vacc_core_config.name = ['vacc_core_', num2str(n)];
	vacc_core_params = {'arith_type', 0, 'out_bin_pt', 17, 'mux_latency', 1, 'use_dsp48', use_dsp48 };
	xBlock(vacc_core_config, vacc_core_params, {din_del{n,1}, AccEnCompare_out1}, {dout{n,1}} );
end
