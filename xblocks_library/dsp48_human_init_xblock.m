...
% block: untitled/Subsystem/dsp48_human_init_xblock/reinterp_ddin1
reinterp_ddin1 = xBlock(struct('source', 'Reinterpret', 'name', 'reinterp_ddin1'), ...
