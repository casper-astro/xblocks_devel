...
bin_pt_din0 = get_var('bin_pt_din0', 'defaults', defaults, varargin{:});
bin_pt_din1 = get_var('bin_pt_din1', 'defaults', defaults, varargin{:});
...
in_bin_pt = max(bin_pt_din0, bin_pt_din1);
...
if use_dsp48
	...
	adder_params = {'opmode_val', '', 'two_48_bit_inputs', 1, 'bit_width_out', bit_width_out, ...
		'bin_pt_out', bin_pt_out, 'arith_type', arith_type};
    ...
    dummy_din1_const = xBlock( struct('source', 'Constant', 'name', 'dummy_din1'), ...
        struct('const', 0, 'arith_type', const_arith_type, 'n_bits', bit_width_out, 'bin_pt', in_bin_pt), ...
        {}, {dummy_din1});
    
    add_din1 = xSignal;
    din1_sel = xBlock(struct('source', 'Mux', 'name', 'din1_sel'), ...
        {'latency', mux_latency}, {en_bool, dummy_din1, din1}, {add_din1});
