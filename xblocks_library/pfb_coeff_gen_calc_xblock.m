...
function coeff_vector = pfb_coeff_gen_calc(PFBSize,TotalTaps,WindowType,n_inputs,nput,fwidth,a,oversample_factor,oversample_index)
...
total_coeffs = circshift(total_coeffs,[0 -oversample_index*(2^PFBSize/oversample_factor)]);
if a < 0
